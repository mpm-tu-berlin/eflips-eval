...
class BaseTest:
    ...
    def scenario(self, session) -> Scenario:
        ...
        stop_1 = Station(
            ...
            name="Industriepark",
            name_short="OS1",
            geom=from_shape(Point(13.514954, 52.625008), srid=4326),
        ...
        stop_2 = Station(
            ...
            name="Duckstraße",
            name_short="OS2",
            geom=from_shape(Point(13.414954, 52.525008), srid=4326),
            is_electrified=False,
        )
        stop_3 = Station(
            scenario=scenario,
            name="Alte Kirche",
            name_short="OS3",
            geom=from_shape(Point(13.514954, 52.525008), srid=4326),
            is_electrified=True,
        ...
        stop_4 = Station(
            ...
            name_short="US1",
            geom=from_shape(Point(13.394954, 52.515008), srid=4326),
            is_electrified=False,
        )
        stop_5 = Station(
            scenario=scenario,
            name="Geldspeicher",
            name_short="US2",
            geom=from_shape(Point(13.384954, 52.510008), srid=4326),
            is_electrified=True,
            charge_type=ChargeType.OPPORTUNITY,
            amount_charging_places=2,
            power_per_charger=150.0,
        ...
        stop_6 = Station(
            ...
            name_short="HV1",
            geom=from_shape(Point(13.400954, 52.525008), srid=4326),
            is_electrified=False,
        )
        stop_7 = Station(
            scenario=scenario,
            ...
            name_short="HV2",
            geom=from_shape(Point(13.410954, 52.520008), srid=4326),
            is_electrified=False,
        )
        stop_8 = Station(
            scenario=scenario,
    ...
    def test_fixtures(self, session, scenario):
        """
        This test does nothing by itself, but it ensures that the fixtures are working correctly.
        :return:
        """
        assert isinstance(scenario, Scenario)
        assert scenario.id == 1
        assert session.query(Event).count() == 0  # No events have been created yet
